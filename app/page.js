    ...
    return (
        <main>
            <section>
                ...
                <h2>Endpoint</h2>
                <p>Simply make an HTTP request to {process.env.NEXT_PUBLIC_SOCKETIO_SERVER}/api/projects/cumulus?latitude=LATITUDE&longitude=LONGITUDE and read the data as a JSON.</p>

                <p>In JavaScript, for example:</p>

                <CodeBlock>
                // TODO: figure out whats going on with the indents (&#9;)
